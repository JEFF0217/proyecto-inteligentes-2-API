...
clases = ["beachballs", "billiardball",
              "bowlingball", "football", "golfball", "paintballs", "pokemonballs", "soccerball", "tennisball", "volleyball"]
...
def predecir(imagen):
    ...
    resultados={"clase": clases[clase["clase"]], "probabilidades":probabilidades}
